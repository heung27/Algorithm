# <img src="https://d2gd6pc034wcta.cloudfront.net/tier/13.svg" width="30"> 14442. 벽 부수고 이동하기 2
			...
			while (size-- > 0) {
				...
				for (int i=0; i<4; i++) {
					...
					if (map[nx][ny] == 0) {
						...
						if (check[nx][ny][pos.t+1]) continue;
						
						queue.offer(new Point(nx, ny, pos.t+1));
						check[nx][ny][pos.t+1] = true;
					}
				}
			}
			cnt++;
