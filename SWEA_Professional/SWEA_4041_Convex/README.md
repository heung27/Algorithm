...
//					else return dist(bottom, o1) - dist(bottom, o2);
			...
			sb.append("#").append(t).append(" ").append(stack.size()).append("\n");
		}
...
## Link
> https://swexpertacademy.com/main/learn/course/subjectDetail.do?courseId=AVuPDj5qAAfw5UW6&subjectId=AWWx2dTqAmADFAW4
